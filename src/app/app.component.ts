      ...
      <div class="mobile-sticky-bar">
        <div class="flex items-center justify-between px-4 py-3">
          <div class="flex items-center gap-3">
            <a href="tel:{{phoneNumber}}" class="flex items-center gap-2 text-white text-sm font-medium hover:text-primary transition-colors" aria-label="Call us">
            ...
            <a [href]="whatsappUrl" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-white text-sm font-medium hover:text-[#25D366] transition-colors" aria-label="Book via WhatsApp">
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a routerLink="/appointment" class="bg-primary text-white text-xs font-sans font-medium uppercase tracking-wider px-5 py-2.5 hover:bg-[#A8833E] transition-colors">
            Book Now
          </a>
        </div>
      </div>
